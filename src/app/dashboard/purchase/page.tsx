...
import { PurchaseData, role } from "@/lib/data";
import { PurchaseType } from "@/types/Data.type";
...
const PurchasePage = () => {
  const renderRow = useCallback((item: unknown) => {
    const purchaseItem = item as PurchaseType;
    ...
    return (
      ...
      >
        ...
        <td className="px-2 py-2 whitespace-nowrap">{purchaseItem.Date}</td>
        <td className="px-2 py-2 whitespace-nowrap">
          {purchaseItem.SupplierName}
        </td>
        <td className="px-2 py-2 whitespace-nowrap">
          {purchaseItem.PayableAmount.toFixed(2)}
        </td>
        <td className="px-2 py-2 whitespace-nowrap">
          {purchaseItem.PaidAmount.toFixed(2)}
        </td>
        <td className="px-2 py-2 whitespace-nowrap">
          {purchaseItem.DueAmount}
        </td>

        <td className="px-2 py-2">
          <div className="flex items-center gap-2">
            <Link href={`/quotations/${purchaseItem.id}`}>
  ...
  return (
    <Card>
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 w-full lg:w-auto">
          ...
          <div className="flex gap-2">
            <Tooltip content="Add Purchase" position="bottom">
      ...
      <div className="mt-4 w-full overflow-x-auto">
        <Table columns={columns} renderRow={renderRow} data={PurchaseData} />
      </div>
