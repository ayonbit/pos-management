              ...
              {item.children ? (
                <div className="">
                  ...
                  >
                    {/* LEFT ACTIVE BAR */}
                    {isOpen && (
                      <span className="absolute left-0 top-1/2 -translate-y-1/2 h-5 w-0.75 bg-black rounded-r-md"></span>
                    )}
                      ...
                      {item.children.map((child, i) => {
                        ...
                        return (
                          ...
                          >
                            {/* ACTIVE BAR */}
                            {isActive && (
                              <span className="absolute left-0 top-1/2 -translate-y-1/2 h-4 w-0.75 bg-black rounded-r-md"></span>
                            )}
